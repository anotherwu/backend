...
public class ProjectDO implements Serializable {
    ...
    @Size(max = 60, message = "调试环境host长度必须小于等于30")
    ...
    @Size(max = 60, message = "开发环境host长度必须小于等于30")
    ...
    @Size(max = 60, message = "预上线环境host长度必须小于等于30")
    ...
    @Size(max = 60, message = "正式环境host长度必须小于等于30")
